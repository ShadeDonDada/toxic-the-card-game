...
* **Demo Mode**
  ...
  * Ads may be displayed between rounds

* **Full Version**

  * Unlimited rounds
  * Full card library unlocked
  * No ads
  * Additional game modes (if applicable)
...
**Format:** Mobile app for iOS & Android

---

# Monetization

* Free demo version with limitations
* One-time purchase or in-app purchase to unlock full access
...
1. Download from the app store/play store
2. Launch the game
3. Complete the tutorial

### Development / Source Build (if applicable)
